...
Usage:
    python -m src.pipelines.ville_ideale.download                  # full crawl
    python -m src.pipelines.ville_ideale.download --depts 35       # one department
    python -m src.pipelines.ville_ideale.download --codes 35238    # specific communes
"""
...
def run(depts: str | None = None, codes: str | None = None, jobdir: str | None = None) -> None:
