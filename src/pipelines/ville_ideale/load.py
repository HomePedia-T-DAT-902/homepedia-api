...
from src.pipelines.ville_ideale.io_utils import ENRICHED, read_jsonl
...
def get_connection():
    """Open a PostgreSQL connection from the standard POSTGRES_* environment variables."""
...
def main() -> None:
    argparse.ArgumentParser(description="Load enriched ville-ideale communes into city_reviews.").parse_args()
    run()
