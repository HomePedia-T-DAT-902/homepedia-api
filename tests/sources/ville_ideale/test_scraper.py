...
from src.sources.ville_ideale.scraper.items import CityItem, ReviewItem  # noqa: E402
from src.sources.ville_ideale.scraper.spiders.reviews_spider import (  # noqa: E402
    INSEE_RE,
    VilleIdealeSpider,
    _parse_review_date,
    _to_float,
